"""Async stats resource client.

Provides async access to IFPA statistical data including country/state player counts,
...
class AsyncStatsClient(AsyncBaseResourceClient):
    """Async client for IFPA statistical data queries.

    This client provides async access to various statistical endpoints maintained by IFPA,
    ...
    Example:
        ```python
        # Get country player statistics asynchronously
        async with AsyncIfpaClient() as client:
            stats = await client.stats.country_players(rank_type="OPEN")
            for country in stats.stats[:5]:
                print(f"{country.country_name}: {country.player_count} players")
        ```
    """

    async def country_players(self, rank_type: str = "OPEN") -> CountryPlayersResponse:
        """Get player count statistics by country asynchronously.
        ...
        Example:
            ...
            async with AsyncIfpaClient() as client:
                women_stats = await client.stats.country_players(rank_type="WOMEN")
            ```
        """
        params: dict[str, Any] = {}
        if rank_type != "OPEN":
        ...
        response = await self._http._request("GET", "/stats/country_players", params=params)
        return CountryPlayersResponse.model_validate(response)

    async def state_players(self, rank_type: str = "OPEN") -> StatePlayersResponse:
        """Get player count statistics by state/province asynchronously.
        ...
        Example:
            ...
            async with AsyncIfpaClient() as client:
                stats = await client.stats.state_players(rank_type="OPEN")
            ...
            async with AsyncIfpaClient() as client:
                stats = await client.stats.state_players()
        ...
        response = await self._http._request("GET", "/stats/state_players", params=params)
        return StatePlayersResponse.model_validate(response)

    async def state_tournaments(self, rank_type: str = "OPEN") -> StateTournamentsResponse:
        """Get tournament count and points statistics by state/province asynchronously.
        ...
        Example:
            ...
            async with AsyncIfpaClient() as client:
                stats = await client.stats.state_tournaments(rank_type="OPEN")
                for state in stats.stats[:5]:
        ...
        response = await self._http._request("GET", "/stats/state_tournaments", params=params)
        return StateTournamentsResponse.model_validate(response)

    async def events_by_year(
        self,
        rank_type: str = "OPEN",
        country_code: str | None = None,
    ) -> EventsByYearResponse:
        """Get statistics about number of events per year asynchronously.
        ...
        Example:
            ...
            async with AsyncIfpaClient() as client:
                stats = await client.stats.events_by_year(rank_type="OPEN")
            ...
            async with AsyncIfpaClient() as client:
                us_stats = await client.stats.events_by_year(country_code="US")
            ```
        """
        params: dict[str, Any] = {}
        if rank_type != "OPEN":
        ...
        response = await self._http._request("GET", "/stats/events_by_year", params=params)
        return EventsByYearResponse.model_validate(response)

    async def players_by_year(self) -> PlayersByYearResponse:
        """Get statistics about number of players per year asynchronously.
        ...
        Example:
            ...
            async with AsyncIfpaClient() as client:
                stats = await client.stats.players_by_year()
                for year in stats.stats[:5]:
                    print(f"{year.year}:")
            ...
            ```
        """
        response = await self._http._request("GET", "/stats/players_by_year")
        return PlayersByYearResponse.model_validate(response)

    async def largest_tournaments(
        self,
        rank_type: str = "OPEN",
        country_code: str | None = None,
    ) -> LargestTournamentsResponse:
        """Get top 25 tournaments by player count asynchronously.
        ...
        Example:
            ...
            async with AsyncIfpaClient() as client:
                stats = await client.stats.largest_tournaments(rank_type="OPEN")
            ...
            async with AsyncIfpaClient() as client:
                us_stats = await client.stats.largest_tournaments(country_code="US")
            ```
        """
        params: dict[str, Any] = {}
        if rank_type != "OPEN":
        ...
        response = await self._http._request("GET", "/stats/largest_tournaments", params=params)
        return LargestTournamentsResponse.model_validate(response)

    async def lucrative_tournaments(
        self,
        major: str = "Y",
        rank_type: str = "OPEN",
        country_code: str | None = None,
    ) -> LucrativeTournamentsResponse:
        """Get top 25 tournaments by tournament value (WPPR rating) asynchronously.
        ...
        Example:
            ...
            async with AsyncIfpaClient() as client:
                stats = await client.stats.lucrative_tournaments(major="Y", rank_type="OPEN")
                for tourney in stats.stats[:10]:
                    print(f"{tourney.tournament_name} ({tourney.tournament_date})")
            ...
            async with AsyncIfpaClient() as client:
                non_major = await client.stats.lucrative_tournaments(major="N")

            # Filter by country
            async with AsyncIfpaClient() as client:
                us_major = await client.stats.lucrative_tournaments(country_code="US")
            ```
        """
        params: dict[str, Any] = {}
        if major != "Y":
        ...
        response = await self._http._request("GET", "/stats/lucrative_tournaments", params=params)
        return LucrativeTournamentsResponse.model_validate(response)

    async def points_given_period(
        self,
        rank_type: str = "OPEN",
        country_code: str | None = None,
        ...
        """Get players with total accumulative points over a time period asynchronously.
        ...
        Example:
            ...
            async with AsyncIfpaClient() as client:
                stats = await client.stats.points_given_period(
            ...
            async with AsyncIfpaClient() as client:
                us_stats = await client.stats.points_given_period(
                    country_code="US",
                    start_date="2024-01-01",
                    limit=10
                )
        ...
        response = await self._http._request("GET", "/stats/points_given_period", params=params)
        return PointsGivenPeriodResponse.model_validate(response)

    async def events_attended_period(
        self,
        rank_type: str = "OPEN",
        country_code: str | None = None,
        start_date: str | None = None,
        ...
        """Get players with total accumulative events over a time period asynchronously.
        ...
        Example:
            ...
            async with AsyncIfpaClient() as client:
                stats = await client.stats.events_attended_period(
                    start_date="2024-01-01",
                    end_date="2024-12-31",
                    limit=25
                )
            ...
            async with AsyncIfpaClient() as client:
                us_stats = await client.stats.events_attended_period(
                    country_code="US",
                    start_date="2024-01-01",
                    limit=10
                )
        ...
        response = await self._http._request("GET", "/stats/events_attended_period", params=params)
        return EventsAttendedPeriodResponse.model_validate(response)

    async def overall(self, system_code: str = "OPEN") -> OverallStatsResponse:
        """Get overall WPPR system statistics asynchronously.
        ...
        Example:
            ...
            async with AsyncIfpaClient() as client:
                stats = await client.stats.overall(system_code="OPEN")
        ...
        response = await self._http._request("GET", "/stats/overall", params=params)
